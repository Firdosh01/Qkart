    ...
    <div>
      <form onSubmit={handleOnSubmit} className='flex items-center justify-center w-full px-5'>
        <div className='w-[450px] p-5 mt-5 rounded-md shadoww'>
          <div className='pb-3'>
            <h3 className='text-[#00A278] font-bold text-2xl'>Register</h3>
          </div>
          <label htmlFor='username'>
            <p className='flex mb-1 text-sm text-[#00A278]'>
              User Name <p className='text-pink-200 '>*</p>
            </p>
            <input
              required
              type="text" 
              ...
              className='w-full rounded-md bg-slate-50 p-[12px] text-black border  border-slate-300 mb-1 hover:border-black focus:border-[#00A278] select-none'
            />
          </label>
          ...
          <label htmlFor='password' className='relative'>
            ...
            <input
              ...
              value={Password}
              onChange={handleOnChange}
              className='w-full  rounded-md bg-slate-50 p-[12px] text-black border  border-slate-300  hover:border-black focus:border-[#00A278] select-none'
            />
            <p className='text-[12px] text-slate-600'>Password must be atleast 6 characters length</p>
            <span
          ...
          <label htmlFor='confirmpassword' className='relative'>
            <p className='flex mb-1 text-sm text-[#00A278]'>
              Confirm Password <p className='flex text-pink-200'>*</p>
            </p>
            <input
              required
            ...
            >
              {isConfVisible ? <AiFillEyeInvisible fontSize={24} fill="#AFB2BF" /> : <AiFillEye fontSize={24} fill="#AFB2BF" />}
            </span>

          </label>
          <button
            type='submit'
            className='px-5 py-2 mt-3 rounded-sm bg-[#00A278] text-white text-sm hover:bg-[#00A261] 
          ...
          <div className='mt-2'>
            <p>Already have an account?
              <Link to='/login'>
                <span className='text-[#00A278] font-bold ml-1'>Login here</span>
              </Link>
            </p>
          </div>
        </div>
